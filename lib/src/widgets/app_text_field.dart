...
import 'package:nb_utils/src/chatgpt/chatgpt.dart';
...
/// - `onFinishChatGPT`: A callback function that takes a String parameter, representing the selected response generated by ChatGPT.
...
class AppTextField extends StatefulWidget {
  ...
  final List<String>? recentListChatGPT;
  final Widget? suffixChatGPTicon;
  final Widget? loadingChatGPT;
  final Function(String)? onFinishChatGPT;
  final InputDecoration? promptFieldInputDecorationChatGPT;
  final bool showDebugLogsChatGPT;
  ...
  AppTextField({
    ...
    this.recentListChatGPT,
    this.loadingChatGPT,
    this.suffixChatGPTicon,
    this.onFinishChatGPT,
    this.promptFieldInputDecorationChatGPT,
    this.showDebugLogsChatGPT = false,
          ...
          ? (widget.decoration!.copyWith(
              suffixIcon: widget.enableChatGPT
                  ? SizedBox(
                      ...
                      showDebugLogs: widget.showDebugLogsChatGPT,
                      testWithoutKey: widget.testWithoutKeyChatGPT,
                      recentList: widget.recentListChatGPT ?? [],
                      icon: widget.suffixChatGPTicon,
                      loading: widget.loadingChatGPT,
                      onFinish: widget.onFinishChatGPT ??
                          (s) {
